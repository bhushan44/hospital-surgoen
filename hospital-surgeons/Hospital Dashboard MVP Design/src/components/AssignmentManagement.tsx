...
export function AssignmentManagement({ onNavigate }: AssignmentManagementProps) {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-gray-900 mb-1">Assignment Management</h1>
        <p className="text-gray-500">Track and manage all doctor assignments</p>
      </div>
