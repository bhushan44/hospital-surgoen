  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-gray-900 mb-2">Credentials & Documents</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {credentials.map((credential) => (
          <div key={credential.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            {/* Title & Description */}
            <h4 className="text-gray-900 mb-1">{credential.title}</h4>
            ...
            {credential.verificationStatus === 'rejected' && (
              <div className="bg-red-50 border border-red-200 rounded p-3 mb-3">
                <p className="text-xs text-red-800">
                  <span>Reason:</span> {credential.rejectionReason}
                </p>
              </div>
            )}
            ...
            <div className="flex gap-2">
              <button className="flex-1 px-3 py-1.5 text-xs bg-gray-100 hover:bg-gray-200 rounded flex items-center justify-center gap-1 transition-colors">
      ...
      {/* Upload Modal - Implementation from previous version */}
      {showUploadModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg">Upload Credential</h3>
