...
export default function HospitalStep5Page() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
      ...
      <p className="text-gray-600 mb-12 text-center">
        Your hospital account has been set up successfully
      </p>
      ...
      <div className="w-full max-w-md space-y-4 mb-12">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-gray-900 font-medium">Search for available doctors and schedule appointments</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-gray-900 font-medium">Check your notifications for updates and requests</p>
          </div>
        </div>
